...
Asena.addCommand({on: 'text', fromMe: wk, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {
    if (message.message.startsWith('whitedevil') && conf.TALKING_WHITEDEVIL !== 'true') {        
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel WhiteDevil özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'WhiteDevil yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'WhiteDevil yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'WhiteDevil, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
